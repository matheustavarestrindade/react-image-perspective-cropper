...
var PerspectiveCropper = function (_a) {
    var src = _a.src, _b = _a.paddingX, paddingX = _b === void 0 ? 100 : _b, width = _a.width, height = _a.height, _c = _a.paddingY, paddingY = _c === void 0 ? 100 : _c, _d = _a.backgroundColor, backgroundColor = _d === void 0 ? "#202020" : _d, draggableDotStyles = _a.draggableDotStyles, _e = _a.draggableDotSize, draggableDotSize = _e === void 0 ? 12 : _e, handleFinishedCrop = _a.handleFinishedCrop, onPointsChange = _a.onPointsChange, onPointsFinishedChange = _a.onPointsFinishedChange, startPoints = _a.startPoints, _f = _a.showGrid, showGrid = _f === void 0 ? true : _f;
